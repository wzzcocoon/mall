...
<body>
    <div class="header">
        ...
        <div class="container blue">
            <div class="title">后台异步通知测试</div>
        </div>
    </div>
    <div class="content">
        <form action="${pageContext.request.contextPath}/pay_notify" class="alipayform" method="POST" target="_blank">
            <div class="element" style="margin-top:60px;">
                <div class="legend">支付宝即时到账交易接口后台通知测试</div>
            </div>
            <div class="element">
