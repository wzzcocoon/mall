...
<body>
    <div class="header">
        ...
        <div class="container blue">
            <div class="title">前台跳转测试页面 </div>
        </div>
    </div>
    <div class="content">
        <form action="${pageContext.request.contextPath}/pay_return" class="alipayform" method="GET" target="_blank">
            <div class="element" style="margin-top:60px;">
                <div class="legend">支付宝即时到账交易接口前台跳转测试页面 </div>
            </div>
            <div class="element">
			...
			<div class="element">
                <div class="etitle">订单状态：</div>
                <div class="einput"><input type="text" name="trade_status" value="TRADE_SUCCESS"></div>
                <br>
                <div class="mark"> </div>
            </div>
